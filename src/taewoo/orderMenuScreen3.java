...
public class orderMenuScreen3 extends JPanel {
	...
	public  orderMenuScreen3 (MainFrame mf) {
...
//		frame.getContentPane().setLayout(null);
		...
		Label1.setBounds(148, 164, 60, 15);
		Label1.setHorizontalAlignment(SwingConstants.CENTER);
		this.add(Label1);

		JLabel Label2 = new JLabel("라떼");
		Label2.setBounds(245, 164, 24, 15);
